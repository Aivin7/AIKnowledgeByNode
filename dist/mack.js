...
async function generateMockData() {
    ...
    const mockData = [
        {
            id: 1,
            vector: await queryVector("秦牧第一个在幽都出生的胎生生灵秦凤青被封印后身体产生的第二意识，后来与秦凤青分成两个不同的人物。幼年被司婆婆收养。本身是凡体，但被村长苏幕遮骗为霸体，开始了一段波澜壮阔的人生 [85]。秦牧走出大墟之后，成为天魔教教主 [126]。助江白圭平叛，开启了延康变法，后成为人皇，机缘巧合下遇到了生父，揭开了自己开皇帝族遗孤的身份 [250]，得成神法门，开启了新的道法神通改革的大世 [262]。其兄秦凤青破封，大闹佛界、悬空界；和初祖人皇等人一起带领诸神逃出毁灭的太皇天，入天阴界复活天阴娘娘 [382]；回百万年前，大闹天庭；于幽都见其母，与秦凤青合体在玉锁关大战幽都诸神；元界解封，见地母元君。昊天尊下界为斩杀地母元君，延康遭到连累，秦牧因此不得不帮助古神天帝、地母元君复活，一人对抗天庭的四位大帝时，舍弃自己的第三只眼，变作没有魂魄的人，后开天辟地赋神魂，获得新生。去往天庭引发瑶池事件，被派遣到太虚之中，意外成为造物主一族的圣婴，并因此促成造物主一族和无忧乡的和解。"),
            payload: {
        ...
        {
            id: 7,
            vector: await queryVector("你好，我是AI助手"),
            payload: {
                text: "你好，我是AI助手",
                source: "test.txt"
            }
        ...
        {
            id: 8,
            vector: await queryVector("我可以帮助回答各种问题"),
            payload: {
                text: "我可以帮助回答各种问题",
                source: "test.txt"
            }
        ...
        {
            id: 9,
            vector: await queryVector("请问你需要什么帮助？"),
            payload: {
                text: "请问你需要什么帮助？",
                source: "test.txt"
            }
        ...
        {
            id: 10,
            vector: await queryVector("自然语言处理是AI的一个分支"),
            payload: {
                text: "自然语言处理是AI的一个分支",
                source: "test.txt"
            }
        ...
        {
            id: 11,
            vector: await queryVector("大语言模型可以理解和生成人类语言"),
            payload: {
                text: "大语言模型可以理解和生成人类语言",
                source: "test.txt"
            }
        },
    ];
